...
The `<uizy-app>` element is hidden until initialization completes, preventing any flash of layout rearrangement. See [`<uizy-app>`](/docs/layout/web-components/app#ready-gate) for details.
