...
```html
<ui-box class="bx-2 br-100p">JD</ui-box>
```
...
```html
<ui-box class="bx-1">36px icon</ui-box>
<ui-box class="bx-2 br-100p">48px circle avatar</ui-box>
<ui-box class="bx-3 br-2">64px thumbnail</ui-box>
```
